...
class DataScienceCatalog extends StatefulWidget {
  const DataScienceCatalog({Key? key}) : super(key: key);

  @override
  State<DataScienceCatalog> createState() => _DataScienceCatalogState();
}

class _DataScienceCatalogState extends State<DataScienceCatalog> {
  List<Course> courses = [];
  ...
  Future<List<Course>> getAllCourses() async {
    ...
    List selectedItem =
        body.where((el) => el["category"] == "Data Science").toList();
    print(selectedItem);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('Catalog Data Science'),
          centerTitle: true,
