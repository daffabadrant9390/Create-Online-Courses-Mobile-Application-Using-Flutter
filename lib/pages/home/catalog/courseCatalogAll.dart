...
import 'getData/courses_api.dart';
import 'package:thinker_app/model/courseModel.dart';

class CourseCatalogAll extends StatefulWidget {
  const CourseCatalogAll({Key? key}) : super(key: key);

  @override
  State<CourseCatalogAll> createState() => _CourseCatalogAllState();
}

class _CourseCatalogAllState extends State<CourseCatalogAll> {
  List<Course> courses = [];
  ...
  Future<List<Course>> getAllCourses() async {
    ...
    // return body;
    print(body.map<Course>(Course.fromJson).toList());
