...
class WebCatalogCourse extends StatefulWidget {
  const WebCatalogCourse({Key? key}) : super(key: key);

  @override
  _WebCatalogCourseState createState() => _WebCatalogCourseState();
}

class _WebCatalogCourseState extends State<WebCatalogCourse> {
  List<Course> courses = [];
  ...
  Future<List<Course>> getAllCourses() async {
    ...
    List selectedItem =
        body.where((el) => el["category"] == "Web Development").toList();
    print(selectedItem);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('Catalog Web Development'),
          centerTitle: true,
